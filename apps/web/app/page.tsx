...
const ANALYZERS = [
  {
    ...
    symbol: "×",
    name: "unused",
    desc: "Scans every import. Flags packages listed in package.json never referenced in source.",
    cmd: "packdaddy --unused",
    flag: "--unused",
    accent: "#ef4444",
  ...
  },
  {
    ...
    symbol: "↑",
    name: "outdated",
    desc: "Queries npm registry directly. Reports every dep with a newer published version.",
    cmd: "packdaddy --outdated",
    flag: "--outdated",
    accent: "#eab308",
  ...
  },
  {
    ...
    symbol: "⚠",
    name: "audit",
    desc: "Hits npm advisory API. Surfaces known CVEs without running npm audit.",
    cmd: "packdaddy --audit",
    flag: "--audit",
    accent: "#f97316",
  ...
  },
  {
    ...
    symbol: "≈",
    name: "size",
    desc: "Walks node_modules recursively. Ranks your heaviest packages by disk footprint.",
    cmd: "packdaddy --size",
    flag: "--size",
    accent: "#3b82f6",
  ...
  return (
    ...
    >
      <nav
        ...
        style={{ padding: "clamp(10px,1.8vh,18px) clamp(16px,2.5vw,28px)" }}
      >
        <Link
          href="/"
        ...
        <div className="absolute right-0 bottom-0 z-10 size-2 translate-x-1/2 translate-y-1/2 rounded-full border border-border bg-background" />
      </nav>
      ...
      <div
        ...
        style={{
          padding:
            "clamp(16px,2.5vh,28px) clamp(16px,2.5vw,28px) clamp(12px,2vh,22px)",
        }}
      >
        <p
          style={{
      ...
      <div
        className="shrink-0"
        style={{ padding: "clamp(12px,2vh,20px) clamp(16px,2.5vw,28px)" }}
      >
        <div
          style={{
            display: "flex",
              ...
              <span
                ...
                style={{
                  ...
                  borderTop: c.startsWith("t")
                    ? `1px solid ${ctaDone ? "var(--foreground)" : "var(--border)"}`
                    : undefined,
      ...
      <footer
        className="relative flex shrink-0 items-center justify-between"
        style={{ padding: "clamp(10px,1.8vh,16px) clamp(16px,2.5vw,28px)" }}
      >
        ...
        >
          {[
            ["github", "https://github.com/01shrvan/packdaddy"],
            ["npm", "https://www.npmjs.com/package/packdaddy"],
          ].map(([l, h]) => (
            <a
              key={l}
              href={h}
